...
public class CodeReferenceExportTestCase
{
    ...
    {
        File basedir = resources.getBasedir("ignoresTypeReferenceInMethod");
    ...
    {
        File basedir = resources.getBasedir("ignoresTypeReferenceInStaticInitializer");
        MavenExecutionResult result = mavenRuntime
                .forProject(basedir)
                .execute("mule-module:analyze");
